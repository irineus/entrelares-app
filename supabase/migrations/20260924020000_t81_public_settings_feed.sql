...
VALUES
	...
	('landing.promo_price_label', 'true', 'bool', 'landing',
	 ...
	 jsonb_build_object(
		'controls', 'A linha de preço promocional do cartão de preço do site (português e inglês) e a nota que diz até quando ele vale.',
		'shown_at', jsonb_build_array('landing'),
		...
		'requires', 'Ao encerrar a promoção, ajustar também os preços (a promoção anunciada vence em 31/12/2026).')),
